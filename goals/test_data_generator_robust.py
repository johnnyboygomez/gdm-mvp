...
def main():
    """Generate 20 test datasets and save to CSV"""
    
    # Generate 20 diverse test datasets (silently)
    all_test_results = generate_random_test_datasets(num_datasets=20, seed=42)
    
    # Save only the main test data to CSV 
    filename = save_to_csv(all_test_results, "step_goals_test_data_20datasets.csv")
